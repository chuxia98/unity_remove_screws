...
namespace Watermelon.SkinStore
{
    ...
    public class SkinsDatabaseEditor : Editor
    {
        ...
        {
            EditorGUILayout.BeginVertical(EditorCustomStyles.Skin.box, GUILayout.ExpandHeight(false));
        ...
        {
            tabsRect = EditorGUILayout.BeginVertical(EditorCustomStyles.Skin.box, GUILayout.ExpandHeight(false));
