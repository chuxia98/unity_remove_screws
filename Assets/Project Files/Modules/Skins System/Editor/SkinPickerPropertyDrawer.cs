...
namespace Watermelon
{
    ...
    public class SkinPickerPropertyDrawer : PropertyDrawer, System.IDisposable
    {
        ...
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
        {
            ...
            if (data.SkinsHandler == null)
            {
                DrawBlock(propertyPosition, "Skins Handler is missing!", null, null);
        ...
        private class PropertyData
        {
            ...
            public void UpdateValues()
            {
                ...
                foreach (AbstractSkinsProvider provider in SkinsHandler.SkinsProviders)
                {
