...
namespace Watermelon
{
    public class PUUIController : MonoBehaviour
    {
        ...
        [SerializeField] PUUIUnlockPanel powerUpUnlockPanel;
        public PUUIUnlockPanel PowerUpUnlockPanel => powerUpUnlockPanel;
        ...
        public void OnLevelStarted(int levelNumber)
        {
            ...
            {
                PUController.PowerUpsUIController.PowerUpUnlockPanel.Show(unlockedPowerUps);
            }
        }
