...
namespace Watermelon
{
    ...
    public class GameData : ScriptableObject
    {
        ...
        [SerializeField] FloatToggle gameplayTimer;
        public bool GameplayTimerEnabled => gameplayTimer.enabled;
        public float GameplayTimerValue => gameplayTimer.newValue;
        ...
        [SerializeField] IntToggle replayingLevelRewardPercent = new IntToggle() { enabled = true, newValue = 20 };
        ...
        [SerializeField] float unscrewAnimationSpeedMultiplier = 1;
        public float UnscrewAnimationSpeedMultiplier => unscrewAnimationSpeedMultiplier;
        ...
        [SerializeField] float unscrewPUAnimationSpeedMultiplier = 1;
        public float UnscrewPUAnimationSpeedMultiplier => unscrewPUAnimationSpeedMultiplier;
