...
namespace Watermelon
{
    ...
    public class IronSourceHandler : AdProviderHandler
    {
        ...
        public override void Init(AdsSettings adsSettings)
        {
            ...
            eventsHolder = Initializer.InitializerGameObject.AddComponent<IronSourceListner>();
            ...
            if (Monetization.VerboseLogging)
                Debug.Log("[AdsManager]: IronSource trying to Initialize..");
        ...
        private void SdkInitializationCompletedEvent()
        {
            if (Monetization.VerboseLogging)
            {
                Debug.Log("[AdsManager]: IronSource is Initialized!");
