...
namespace Watermelon
{
    ...
    public class UnityAdsLegacyHandler : AdProviderHandler
    {
        ...
        public override void Init(AdsSettings adsSettings)
        {
            ...
            unityAdvertisment = Initializer.InitializerGameObject.AddComponent<UnityAdvertismentListener>();
            unityAdvertisment.Init(adsSettings, this);

            Advertisement.Init(appId, Monetization.DebugMode, unityAdvertisment);
        ...
        private class UnityAdvertismentListener : MonoBehaviour, IUnityAdsLoadListener, IUnityAdsShowListener, IUnityAdsInitializationListener
        {
            ...
            public void OnInitializationFailed(UnityAdsInitializationError error, string message)
            {
                ...
                {
                    Advertisement.Init(appId, Monetization.DebugMode, this);
                }
                else
                {
                    if (Monetization.VerboseLogging)
