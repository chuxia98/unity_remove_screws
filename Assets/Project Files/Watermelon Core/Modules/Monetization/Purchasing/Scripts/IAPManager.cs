    ...
    public static class IAPManager
    {
        ...
        public static void Init(MonetizationSettings monetizationSettings)
        {
            ...
            if(messagesCanvasPrefab != null)
            {
                ...
                canvasGameObject.transform.SetParent(Initializer.Transform);
                ...
                canvasGameObject.GetComponent<IAPMessagesCanvas>().Init();
            }
            else
            {
            ...
            for (int i = 0; i < items.Length; i++)
            {
                ...
                {
                    Debug.LogError(string.Format("[IAP Manager]: Product with the type {0} has duplicates in the list!", items[i].ProductKeyType));
                }
            }
