    ...
    public class Particle
    {
        ...
        public Particle(string particleName, GameObject particlePrefab)
        {
            ...
            if (particlePrefab == null)
                Debug.LogError(string.Format("[Particles]: Prefab isn't linked for {0} particle", particleName));
        }
        ...
        public void Init()
        {
            ...
            {
                Debug.LogError(string.Format("[Particles]: Particle ({0}) prefab doesn't contain a ParticleSystem component!", particleName), particlePrefab);
            }
        }
