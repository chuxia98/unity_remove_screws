...
namespace Watermelon
{
    ...
    public sealed class ParticleCase
    {
        ...
        /// <summary>
        /// The particle data associated with this ParticleCase.
        /// </summary>
        ...
        public ParticleCase(Particle particle, bool isDelayed)
        {
            ...
            // Check if the particle has special behavior attached
            if (particle.SpecialBehaviour)
            {
                // Get special behavior component from the pooled object
                SpecialBehavior = particleObject.GetComponent<ParticleBehaviour>();
